<template>
    <div>
       <h3 class="text-bold">Cancelled Orders</h3>
                     ...
                     <div class="table-responsive">
                            <table class="table table-centered table-nowrap mb-0">
                               ...
                               <tbody>
                                ...
                                <tr role="button" @click="view_more(order)" v-for="(order, index) in orders.canceled_orders.data" :key="index" v-else>
                                    <td>  {{ index+1 }} </td>
                                ...
                                <tr v-show="orders.canceled_orders.total === 0 " class="text-danger">Nothing Here . . .</tr>
                                </tbody>
                            </table>
                        </div>
